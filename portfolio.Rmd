...
Which made me question weather all players are going to score more than 15.

My null hypothises is that the number of scores in the first try is greater than the second try

```{r t_test, echo=TRUE}
observed_first_score <-game_data$first.time
observed_second_score <-game_data$second.time
boxplot(observed_first_score,observed_second_score)
```